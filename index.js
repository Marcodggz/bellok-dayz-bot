...
// ================== EMBEDS ==================
function embedPvp({ killer, victim, weapon }, eventTimestamp = null) {
  const txt = weapon
...
function embedExplosion({ victim, device }, eventTimestamp = null) {
...
function buildKillEmbed(k, eventTimestamp = null) {
  if (k.type === "pvp") return embedPvp(k, eventTimestamp);
  if (k.type === "explosion") return embedExplosion(k, eventTimestamp);
  return null;
}
